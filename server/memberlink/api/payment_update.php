...
$membershipId = filter_input(INPUT_GET, 'membershipId', FILTER_SANITIZE_NUMBER_INT);
$membershipId = $membershipId !== null ? intval($membershipId) : null;

// Sanitize billplz nested array
$billplz_id = filter_var($_GET['billplz']['id'] ?? '', FILTER_SANITIZE_STRING);
$billplz_paid_at = filter_var($_GET['billplz']['paid_at'] ?? '', FILTER_SANITIZE_STRING);
$billplz_paid = filter_var($_GET['billplz']['paid'] ?? '', FILTER_SANITIZE_STRING);
$billplz_x_signature = filter_var($_GET['billplz']['x_signature'] ?? '', FILTER_SANITIZE_STRING);

$data = array(
    'id' => $billplz_id,
    'paid_at' => $billplz_paid_at,
    'paid' => $billplz_paid,
    'x_signature' => $billplz_x_signature
);
...
$signed = hash_hmac(
    'sha256',
    $signing,
    '94d737a89cc4562daf98f4dc81f2b5b6c334ac073a2cfc966a73938e1ed8e7f7faf05791900e95b1dc865dcb5105eda1f8ccca89245670d6ad2028a321e4efd2'
);
...
if ($signed === $data['x_signature']) {
            ...
            <div class='receipt-container'>
                ...
                <div class='receipt-content'>
                    <div class='company-info'>
                        ...
                        <h3 style='margin:0;'>My Member Link</h3>
                        <p style='color:#666; margin:5px 0;'>Inasis Tradewinds, UUM, 06010, Changlun</p>
                    </div>
                    ...
                    <div class='membership-details'>
                        ...
                        <table class='w3-table'>
                            ...
                            <tr>
                                ...
                                <td>{$membership['membership_duration_month']} months</td>
                            </tr>
                            <tr>
    ...
    $sqldeletepending = "DELETE FROM `membership_purchase_tbl` WHERE `payment_status` = ?";
    $stmt2 = $conn->prepare($sqldeletepending);
    $del_val = "Pending";
    $stmt2->bind_param("s", $del_val);
    $stmt2->execute();
} else {
